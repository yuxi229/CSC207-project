...
public class DBRoomDataAccessObject implements NavigationDataAccessInterface{
    ...
    public Room get(String roomCode) {
        ...
        if (responseBody.getInt(STATUS_CODE_LABEL) == SUCCESS_CODE) {
            final JSONObject userJSONObject = responseBody.getJSONObject("roomcode");
            final String name = userJSONObject.getString(ROOMCODE);

            return roomFactory.create(roomCode);
        }
        else {
